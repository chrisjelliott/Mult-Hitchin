...
\vasily{If there are no singularities, I think that's correct, but perhaps we can extend the comment above for the case of non-empty D?} \chris{I think figuring out how to phrase the singuarity conditions on the base and to verify that the fibers are Lagrangian in the derived geometry language would be tricky, and it's a bit orthogonal to the rest of the paper.  It's probably doable if you think it's worth it.  What do you think?}
\end{remark}
