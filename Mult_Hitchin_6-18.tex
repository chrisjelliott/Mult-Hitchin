...
\begin{align*}
\langle \alpha_i, \beta_i' \rangle &= \langle \rho_\phi^*(\Ad_\phi(\beta_i + \wt \beta)), \rho_\phi^*(\Ad_\phi^*)^{-1}(\beta'_i) \rangle \\
&= \langle \rho_\phi^*(\beta_i + \wt \beta), \rho_\phi^*(\beta'_i) \rangle
\end{align*}
where now 
